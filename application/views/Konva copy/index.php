...
<body class="theme-red">
    ...
    <!-- #Top Bar -->
    <section>
        <?php $this->load->view("Konva/sidebar.konva.php",  array("building"=>$building, 'query' => $query));?>
    </section>
    <section>
      ...
      function initFloorList(id = ""){
            $.ajax({
                ...
                success:function(data){
                  ...
                  if(data.status == "success"){
                    var html = "";
                    var urll = bs+'konva?building='+id+'&floor=';

...
<body class="theme-red">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                            <table id="id_tbl_room" class="table table-hover table-bordered">
                                                <thead>
                                                    ...
                                                    <th style="width: 150px !important;">Cancel Time</th>
                                                    <th>Room</th>
                                                    <th>Room Adddress</th>
                                                    <th>Alocation</th>
                                                    <th>Partisipant</th>
    ...
    <script>
        ...
        function init(alocation = ""){
            ...
            if(alocation == ""){
                var url =bs+"report/get/cancel-order-all/"+date1+"/"+date2;
            }else{
                var url =bs+"report/get/cancel-order-alocation/"+alocation+"/"+date1+"/"+date2;
            }
            $.ajax({
                url : url,
                type : "GET",
        ...
        function alertExportToAll(type){
            ...
            switch(type){
                case "excell" : 
                    if(filter_alocation == ""){
                        var url = bs+"report/export-all/cancel-order/excell/"+date1+"/"+date2;
                    }else{
                        var url = bs+"report/export/cancel-order/excell/"+filter_alocation+"/"+date1+"/"+date2;
                    }
                    exportExcell(url)
                    break;
                default:

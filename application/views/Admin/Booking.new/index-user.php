...
<body class="theme-red">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                <li role="presentation" class="active"><a href="#homepage" data-toggle="tab">Booking List</a></li>
    ...
    <div class="modal fade" id="id_mdl_partisipant" tabindex="-1" role="dialog">
                <div class="modal-dialog model-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="id_mdl_partisipantLabel">Participant of  <b id="id_partisipant_title"></b></h4>
                        </div>
                        <div class="modal-body " id="id_mdl_partisipant_body">
                                ...
                                <div class="header">
                                    <div class="row clearfix">
                                        <div class="col-xs-12 col-sm-12">
                                            <h2>Internal participant of meeting </h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="body">
                            ...
                            <div class="card">
                                <div class="header">
                                    <div class="row clearfix">
                                        <div class="col-xs-12 col-sm-12">
                                            <h2>External participant of meeting</h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="body">
    ...
    <div class="modal fade" id="id_mdl_attendance" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="idmdlcrLabel">Attendance Meeting - <b id="id_att_text_name"></b></h4>
                        </div>
                        <div class="modal-body " id="id_mdl_reschedule_body">
                            <!-- <form id="frm_reschedule"> -->
                                <label for="">Status Attendance</label>
                                <div class="form-group">
                                    <input type="hidden" id="id_att_booking_id">
                                    <button type="button" onclick="clickAttendanceStatus('noattend')" class="btn btn-danger m-t-15 waves-effect">No Attend</button>
                                    <button type="button" onclick="clickAttendanceStatus('attend')" class="btn btn-primary m-t-15 waves-effect">Attend</button>
                                </div>
                                <label for="">Reason</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <textarea class="form-control" cols="2" id="id_att_reason" ></textarea>
                                    </div>
                                </div>
    ...
    <script src="<?= base_url()?>assets/process/booking/index-user.js"></script>
    </body>
</html>

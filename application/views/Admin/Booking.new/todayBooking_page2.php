...
<div class="row clearfix" style="max-height: 350px;overflow-y: scroll;;background: #fff;">
    <!--START FORM BOOKING -->
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        ...
        <div class="row clearfix">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <b class="lbl_text">ORGANIZER(PIC/HOST)</b> <b style="color:red">*</b>
                <div class="input-group">
        ...
        <!--  -->
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="id_pantry_area" >
                ...
                <div class="row clearfix">
                    <div class="col-xs-12">
                        ...
                        <div class="input-group">
                            ...
                            multiple id="id_frm_crt_participant" class="form-control show-tick" data-live-search="true">
                            </select>
                            <span class="input-group-addon">

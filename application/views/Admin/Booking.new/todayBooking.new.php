            ...
            <div class="body">
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-6 col-xs-6">
                        ...
                        <div class="form-group-filter">
                            ...
                            <div class="form-group-filter-form">
                                <button style="font-size: 16px;position: relative;left: -1px; top: 0px;" type="button" class="btn btn-noshadow btn-block waves-effect">Today, 28 Aug 2024</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-6 col-xs-6">
                        ...
                        <div class="form-group-filter">
                            ...
                            <div class="form-group-filter-form">
                                <button style="font-size: 16px;position: relative;left: -1px; top: 0px;" type="button" class="btn btn-noshadow btn-block waves-effect">Gedung Pama 1</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-6 col-xs-6">
                        ...
                        <div class="form-group-filter">
                            <div class="form-group-filter-icon">
                                <i style="font-size: 24px;position: relative;left: -1px; top: 0px;" class="material-icons">filter_list</i>
                            </div>
                            <div class="form-group-filter-form">
                                <button style="font-size: 16px;position: relative;left: -1px; top: 0px;" type="button" class="btn btn-noshadow btn-block waves-effect">Capabilities</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row clearfix">
                    <div class="col-xs-12">
                        <button style="font-size: 16px;position: relative;left: -1px; top: 0px;" type="button" class="btn btn-primary btn-block btn-lg waves-effect">Find Room</button>
                    </div>
                </div>
            </div>
        </div>

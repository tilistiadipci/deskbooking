...
<head>
    ...
    <link href="<?= base_url()?>assets/external/jquery-timepicker/jquery.timepicker.min.css" rel="stylesheet" />
    <link href="<?= base_url()?>assets/external/tippy-theme-light.min.css" rel="stylesheet" />
...
<body class="theme-red">
            ...
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <ul class="nav nav-tabs tab-nav-right" role="tablist">
                        ...
                        <li role="presentation" class="active"><a href="#booknowpage" data-toggle="tab"><b>Training Room</b></a></li>
                        <li role="presentation" class="active"><a href="#booknowpage" data-toggle="tab"><b>No Room</b></a></li>
                    </ul>
                </div>
            </div>
            <div class="row clearfix">
    ...
    <textarea id="id_facility" style="display: none;"><?= $facility?></textarea>
    <?php $this->load->view("_partials/js_dashboard.php");?>
    <!-- TimePicker -->
    <script src="<?= base_url()?>assets/external/jquery-timepicker/jquery.timepicker.min.js"></script>
    <!-- end TimePicker -->
    <!-- Datatables -->
    ...
    <!--Tippy -->
    <script src="<?= base_url()?>assets/external/popper.min.js"></script>
    <script src="<?= base_url()?>assets/external/tippy-bundle.umd.min.js"></script>
    <!-- end Tippy -->

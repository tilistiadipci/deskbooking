                            ...
                            <div class="card">
                                ...
                                <div class="body ">
                                    <form id="frm_save_general">
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-xs-12 col-md-6">
                                                <label for="">Desk check-in</label>
                                                <div class="form-group">
                                                    <select required=""  name="config_release_room_checkin_enable" id="id_config_release_room_checkin_enable" class="form-control show-tick">
                                                    </select>
                                                    <small>This feature requires users to check-in at a kiosk desk & release a desk when users not present</small>
                                                </div>
                                                <label for="">Check-in release time</label>
                                                <div class="form-group">
                                                    <select required=""  name="config_release_room_checkin_time" id="id_config_release_room_checkin_time" class="form-control show-tick">
                                                    </select>
                                                    <small>Check-in maximum after schedule starts</small>
                                                </div>
                                                <label for="">Notification reminder</label>
                                                <div class="form-group">
                                                    <div class="input-group" style="width: 250px">
                                                        <div class="form-line" style="width: 250px">
                                                            <input maxlength="6"  type="number" name="notification_reminder" id="id_notification_reminder" class=" form-control"  required="" placeholder="Duration per minutes ...">
                                                        </div>
                                                        <span class="input-group-addon">mins</span>
                                                    </div>
                                                    <small>Notification will appear before the schedule starts</small>
                                                </div>
                                                ...
                                                <div class="row clearfix">
                                                    <div class="col-xs-12 col-md-6">
                                                        <label for="">Extended time maximum</label>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-xs-12 col-md-6">
                                                        <label for="">Extended notification time</label>
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <label for="">Login Web Captcha</label>
                                                <div class="form-group">
                                                    <select required="" name="enable_security_captcha" id="id_enable_security_captcha" class="form-control show-tick">
                                                    </select>
                                                    <small>This feature requires users to fill in a captcha when sign-in in to the web..</small>
                                                </div>

                                                <label for="">Book/order duration</label>
                                                <div class="form-group">
                                                    <select required="" name="config_book_duration" id="id_config_book_duration" class="form-control show-tick">
                                                    </select>
                                                    <small>Booking desk with duration.</small>
                                                </div>
                                                ...
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-xs-12 col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <select required=""  name="duration" id="id_config_min_duration" class="form-control show-tick">
                                                            </select>
                                                        </div>
                                                        <small>The Limited to minimum booking time</small>
                                                    </div>
                                                    <div class="col-xs-12 col-md-6">
                                                        <label for="">Max duration</label>
                                                        <div class="form-group">
                                                            <select required=""  name="duration" id="id_config_max_duration" class="form-control show-tick">
                                                            </select>
                                                        </div>
                                                            <small>The Limited to maximum booking time</small>

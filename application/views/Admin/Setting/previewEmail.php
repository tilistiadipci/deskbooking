              ...
              <table class="full-width-gmail-android" cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                  <td class="header center" width="100%">
                    <a href="#">
                      <?= $data['title_of_text']?> TITLE MEETING/AGENDA
                    </a>
                  </td>
                </tr>
              </table>
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                  ...
                  <tr>
                    <td class="left" style="padding-bottom:20px; text-align:left;">
                      <b><?= $data['to_text']?> &nbsp;:</b> Jhon Doe <br>
                      <b><?= $data['title_agenda_text']?> &nbsp;:</b> Agenda of meeting <br>
                      <b><?= $data['date_text']?>&nbsp;&nbsp;:</b> <?= date('Y-m-d') ?> <br>
                      <b><?= $data['room']?> &nbsp;&nbsp;&nbsp;:</b> Room Example <br>
                      <b><?= $data['detail_location']?> &nbsp;&nbsp;&nbsp;:</b> Location <br>
                      <!-- Tanggal: %tanggal%<br> -->
                    </td>
                  </tr>
                </table>
                  ...
                  <tr>
                    <td class="mobile-center" align="left" style="padding:40px 0;">
                      <div class="mobile-center" align="left">
                        <a href="#"
                        style="background-color:#41CC00;background-image:url(https://www.filepicker.io/api/file/N8GiNGsmT6mK6ORk00S7);border:1px solid #407429;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:17px;font-weight:bold;text-shadow: -1px -1px #47A54B;line-height:37px;text-align:center;text-decoration:none;width:190px;-webkit-text-size-adjust:none;mso-hide:all;"><?= $data['attendance_text']?></a> 
                        <a href="#"
                        style="background-color:#41CC00;background-image:url(https://www.filepicker.io/api/file/N8GiNGsmT6mK6ORk00S7);border:1px solid #407429;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:17px;font-weight:bold;text-shadow: -1px -1px #47A54B;line-height:37px;text-align:center;text-decoration:none;width:190px;-webkit-text-size-adjust:none;mso-hide:all;"><?= $data['attendance_no_text']?></a>
                      </div>
                  ...
                  <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#E5E5E5">
                    <tr>
                      <td class="center" style="padding:25px; text-align:center;">
                        <?= $data['support_text']?> <b><a href="<?= $data['link']?>" target="__blank"><?= $data['foot_text']?></a></b> 
                      </td>
                    </tr>
                  </table>
                </td>

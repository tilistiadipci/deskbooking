            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="card" style="border-radius: 12px;  padding: 20px;box-shadow: 0 4px 6px -1px rgba(0,0,0,0.15);">
                        <div style="display: flex; justify-content: space-between;">
                            <div>
                                <div style="color: #6B7280; font-size: 12px; font-weight: 600; letter-spacing: 0.5px;">TODAY'S BOOKINGS</div>
                                <div style="font-size: 32px; font-weight: 700; color: #111827; margin: 10px 0;"><?= $today_bookings ?></div>
                                <div style="color: #6B7280; font-size: 13px;"><?= $today_bookings == 0 ? 'No bookings today' : 'Bookings for today' ?></div>
                            </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="card" style="border-radius: 12px;  padding: 20px;box-shadow: 0 4px 6px -1px rgba(0,0,0,0.15);">
                        <div style="display: flex; justify-content: space-between;">
                            <div>
                                <div style="color: #6B7280; font-size: 12px; font-weight: 600; letter-spacing: 0.5px;">EMPLOYEES / USERS</div>
                                <div style="font-size: 32px; font-weight: 700; color: #111827; margin: 10px 0;"><?= count($employee) ?></div>
                                <div style="color: #6B7280; font-size: 13px;">Active users</div>
                            </div>
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12" style="display: flex; flex-direction: column;">
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="display: flex; flex-direction: column; gap: 20px;">
                            <div class="card" style="border-radius: 12px;box-shadow: 0 4px 6px -1px rgba(0,0,0,0.15); margin-bottom: 20px;">
                                <div class="header" style="border-bottom: none; padding-bottom: 0;">
                                    <h2 style="font-weight: 700; color: #111827; font-size: 14px; letter-spacing: 0.5px;">POPULAR DESKS</h2>
                                </div>
                                <div class="body">
